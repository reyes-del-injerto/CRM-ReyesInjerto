							...
							<div class="row">
								<div class="col-12 col-md-6 d-flex align-items-center">
									...
									<?php } else { ?> <!-- Info si viene de Clientes -->
										<div class="names-profiles">
											<h2 id="client_fullname">ojo</h2>
											<a style="color:#000;font-size:15px;" class="custom-badge rounded-pill bg-warning" href="#" id="client_procedure_type"></a>
							...
							<form id="new_task" action="scripts/sales/add_lead_task.php" method="POST">
								...
								<script>
									document.addEventListener('DOMContentLoaded', (event) => {
										...
										const localStorageSpan = document.getElementById('localstorageid');

										// Asignar el valor de user_id al contenido del span
										localStorageSpan.textContent = userId;
										// Asignar el valor de user_id al atributo value del input hidden
										sellerIdInput.value = userId;
									});
								</script>
								<div class="row">
									<div class="col-12">
