...
!(function (e) {
  ...
  (t = {
    ...
    (i.prototype = {
      ...
      _initFileManager: function () {
        ...
        (i.uploadStartTime = t.now()),
          (i.fileManager = {
            ...
            exists: function (t) {
              var a = i.fileManager.getIdList();
              return (
                -1 !== e.inArray(t, a) && (!altId || -1 !== e.inArray(altId, a))
              );
            },
            count: function () {
        ...
        (i =
          ...
          (V.defaults = {
            ...
            fileActionSettings: {
              ...
              showDrag: !0,
              showRotate: !0,
              removeIcon: '<i class="fa fa-trash-can"></i>',
              removeClass: K,
      ...
      _handleRotation: function (e, t, i) {
        var a,
          r,
          n,
          o,
          ...
          u = 1,
          f = t[0];
        if (t.length && !e.hasClass("hide-rotate")) {
          switch (
            ((o = t.css("transform")),
            o && t.css("transform", "none"),
            (l = f.naturalWidth || t.outerWidth() || 0),
            (s = f.naturalHeight || t.outerHeight() || 0),
            (u = l > s && 0 != l ? (s / l).toFixed(2) : 1),
            o && t.css("transform", o),
            (i = i || 0),
            (n = i % 360),
            (a = "rotate(" + i + "deg)"),
            ...
            case 270:
              ...
              c =
                1 === u
                  ? " translateX(-100%)"
                  : " translate(-" + p + "%, " + g + "%) scale(" + u + ")";
          }
          t.addClass("rotate-animate").css("transform", a + c),
            setTimeout(function () {
              t.removeClass("rotate-animate").css("transform", r + c),
                e.data("angle", n);
            }, d.fadeDelay);
        }
      },
      ...
      _generatePreviewTemplate: function (
        ...
        var v,
          ...
          I = y,
          E = "type-default",
          A = f || x._renderFileFooter(i, y, d, "auto", l),
          z = x.preferIconicPreview,
          D = x.preferIconicZoomPreview,
          j = z ? "other" : i,
          $ = k.split(".").pop().toLowerCase();
        return (
          (w =
            400 > F
              ? x.previewSettingsSmall[j] || x.defaults.previewSettingsSmall[j]
              : x.previewSettings[j] || x.defaults.previewSettings[j]),
          w &&
            e.each(w, function (e, t) {
              P += e + ":" + t + ";";
            }),
          (b = function (a, l, d, c, f) {
            var h,
              v = d ? "zoom-" + o : o,
              w = x._getPreviewTemplate(a),
              b = (u || "") + " " + c;
            return (
              x.frameClass && (b = x.frameClass + " " + b),
              d && (b = b.replace(" " + t.SORT_CSS, "")),
              (w = x._parseFilePreviewIcon(w, r)),
              "object" !== i ||
                n ||
                e.each(x.defaults.fileTypeSettings, function (e, t) {
                  "object" !== e &&
                    "other" !== e &&
                    t(r, n) &&
                    (E = "type-" + e);
              ...
              t.isEmpty(m) ||
                (void 0 !== m.title && null !== m.title && (S = m.title),
                void 0 !== m.alt && null !== m.alt && (I = S = m.alt)),
              (h = {
                previewId: v,
                caption: y,
                title: S,
                alt: I,
                frameClass: b,
                type: x._getFileType(n),
                fileindex: p,
                fileid: s || "",
                filename: k,
                typeCss: E,
                footer: A,
                data: d && f ? x.zoomPlaceholder + "{zoomData}" : l,
                template: g || i,
                style: P ? 'style="' + P + '"' : "",
          ...
          (C =
            x.fileActionSettings.showRotate &&
            -1 !== e.inArray($, x.rotatableFileExtensions)),
          x.fileActionSettings.showZoom &&
            ((_ = "kv-zoom-thumb"),
            C && (_ += " rotatable" + (D ? " hide-rotate" : "")),
            (T = b(D ? "other" : i, a, !0, _, h))),
          (T =
            "\n" +
            x._getLayoutTemplate("zoomCache").replace("{zoomContent}", T)),
          "function" == typeof x.sanitizeZoomCache &&
            (T = x.sanitizeZoomCache(T)),
          (_ = "kv-preview-thumb"),
          C &&
            (_ +=
              " rotatable" +
              (z || x.hideThumbnailContent ? " hide-rotate" : "")),
          (v = b(z ? "other" : i, a, !1, _, h)),
          v.setTokens({ zoomCache: T })
        );
      },
      ...
      _updateFileDetails: function (e) {
        ...
        !d && s.fileManager.count() > 0
          ? ((o = s.fileManager.getFirstFile()),
            console.log("KV SAYS", o),
            (i = o.nameFmt))
          : (i = d ? s.slug(d) : "_"),
      ...
      _renderFileActions: function (e, t, i, a, r, n, o, s, l, d, c, u, f) {
        ...
        return (
          a &&
            (_ = p._getLayoutTemplate("actionDelete").setTokens({
              removeClass: k,
          ...
          n &&
            (h = p._getLayoutTemplate("actionZoom").setTokens({
          ...
          o &&
            ...
            (v = p._getLayoutTemplate("actionDrag").setTokens({
              dragClass: g,
        ...
        a.length
          ? a
              ...
              .on("focusin.fileinput", function () {
                setTimeout(function () {
                  i.val() ||
                    (t._toggleLoading("hide"), t._setFileDropZoneTitle()),
                    a.off(r);
                }, 2500);
              })
