...
$(document).ready(function () {
  ...
  if ($("#market-area").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#market-area"), options);
    chart.render();
  }
  ...
  if ($("#pressure-chart").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#pressure-chart"), sCol);
  ...
  if ($("#sleep-chart").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#sleep-chart"), options);
    chart.render();
  }
