...
<div class="card-body">
	<form method="POST" action="scripts/add/advance_invoice.php" id="new_invoice">
		...
		<div class="row">
			...
			<div class="col-12 col-md-4">
				<div class="input-block local-forms">
					...
					<div class="input-group mb-3">
						...
						<input type="number" class="form-control" name="advance_amount" id="r_advance_amount" placeholder="0" min=0 required>
			...
			<div class="col-12 col-md-4">
				<div class="input-block local-forms">
					...
					<select class="form-control select" name="payment_method" id="r_payment_method" required>
						<option value="" selected disabled>Selecciona</option>
			...
			<div class="col-12 col-md-4">
				<div class="input-block local-forms">
					...
					<input type="date" class="form-control" name="procedure_date" id="r_procedure_date" required readonly>

				</div>
				<label class="no-style" id="cbx_open_date">
					<input type="checkbox" name="open_date" id="r_open_date" value="1" disabled><strong>Fecha abierta para 2024</strong></input>
				</label>
			</div>
			<div class="mb-3"></div>
			<div class="col-12 col-md-4">
...
<script>
	...
	function setPendingAmount() {
		...
		$("#r_pending_amount").val(pending_amount);
	}
