...
try {
    ...
    $sql_row = "SELECT t_a.id, t_a.date, t_a.clinic, t_a.doctor, t_a.type, t_a.inv_type, t_a.notes, t_a.month FROM enf_protocols_appointments  t_a WHERE t_a.num_med_record = ? ORDER BY t_a.date ASC";
